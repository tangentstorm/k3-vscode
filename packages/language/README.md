...
- [src/k-3.langium](src/k-3.langium) -  The grammar definition of your language
- [src/k-3-module.ts](src/k-3-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/k-3-validator.ts](src/k-3-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/k-3.monarch.ts](src/syntaxes/k-3.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/k-3.tmLanguage.json](syntaxes/k-3.tmLanguage.json) - Textmate based syntax highlighting instructions.
